...
The build action consists of building the *translate/translate.cproj* file for selected endianesses and putting the output libraries into a single *zip* archive.
